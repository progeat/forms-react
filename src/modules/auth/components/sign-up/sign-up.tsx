...
export const Signup = ({ onSubmit, onLink }: SignupProps) => {
  ...
  return (
    ...
    >
      ...
      <div className={styles.sex}>
        ...
        <p className={styles.description}>Выберите пол</p>
      ...
      <a className={styles.link} role="button" onClick={onLink}>
        Вход
      </a>
    </form>
  );
